...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'SiteConfiguration.background'
        db.alter_column(u'main_siteconfiguration', 'background', self.gf('django.db.models.fields.files.FileField')(max_length=100, null=True))

        # Changing field 'SiteConfiguration.email_to_notifications'
        db.alter_column(u'main_siteconfiguration', 'email_to_notifications', self.gf('django.db.models.fields.EmailField')(max_length=75, null=True))
        # Adding field 'ImageSlider.category'
        db.add_column(u'main_imageslider', 'category',
    ...
    def backwards(self, orm):
        ...
        # Changing field 'SiteConfiguration.background'
        db.alter_column(u'main_siteconfiguration', 'background', self.gf('django.db.models.fields.files.FileField')(default='1', max_length=100))

        # Changing field 'SiteConfiguration.email_to_notifications'
        db.alter_column(u'main_siteconfiguration', 'email_to_notifications', self.gf('django.db.models.fields.EmailField')(default='guillermoalvarado89@gmail.com', max_length=75))
        # Deleting field 'ImageSlider.category'
        db.delete_column(u'main_imageslider', 'category')
