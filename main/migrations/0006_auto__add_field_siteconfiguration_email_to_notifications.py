...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'SiteConfiguration.email_to_notifications'
        db.add_column(u'main_siteconfiguration', 'email_to_notifications',
                      self.gf('django.db.models.fields.EmailField')(default=None, max_length=75),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'SiteConfiguration.email_to_notifications'
        db.delete_column(u'main_siteconfiguration', 'email_to_notifications')
