...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'CategorySample.photo'
        db.delete_column(u'main_categorysample', 'photo')


    def backwards(self, orm):
        # Adding field 'CategorySample.photo'
        db.add_column(u'main_categorysample', 'photo',
