...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'main_order', (
            ...
            ('product', self.gf('django.db.models.fields.related.ForeignKey')(related_name='orders', to=orm['main.Product'])),
            ('client', self.gf('django.db.models.fields.related.ForeignKey')(related_name='orders', to=orm['auth.User'])),
        ...
        db.delete_column(u'main_product', 'name')

        # Adding field 'Product.model'
        db.add_column(u'main_product', 'model',
    ...
    def backwards(self, orm):
        ...
        db.add_column(u'main_product', 'name',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=100),
                      keep_default=False)

        # Deleting field 'Product.model'
        db.delete_column(u'main_product', 'model')
