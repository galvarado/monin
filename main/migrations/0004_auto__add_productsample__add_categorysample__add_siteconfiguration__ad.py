...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'ProductSample'
        db.create_table(u'main_productsample', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=100)),
            ('active', self.gf('django.db.models.fields.BooleanField')(default=True)),
            ('category', self.gf('django.db.models.fields.related.ForeignKey')(related_name='products_sample', to=orm['main.CategorySample'])),
            ('photo', self.gf('django.db.models.fields.files.FileField')(max_length=100)),
        ))
        db.send_create_signal(u'main', ['ProductSample'])

        # Adding model 'CategorySample'
        db.create_table(u'main_categorysample', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=100)),
            ('active', self.gf('django.db.models.fields.BooleanField')(default=True)),
            ('photo', self.gf('django.db.models.fields.files.FileField')(max_length=100)),
        ))
        db.send_create_signal(u'main', ['CategorySample'])

        # Adding model 'SiteConfiguration'
        db.create_table(u'main_siteconfiguration', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('background', self.gf('django.db.models.fields.files.FileField')(max_length=100)),
            ('active_background', self.gf('django.db.models.fields.BooleanField')(default=True)),
        ))
        db.send_create_signal(u'main', ['SiteConfiguration'])

        # Adding field 'Product.photo'
        db.add_column(u'main_product', 'photo',
                      self.gf('django.db.models.fields.files.FileField')(default=None, max_length=100),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting model 'ProductSample'
        db.delete_table(u'main_productsample')

        # Deleting model 'CategorySample'
        db.delete_table(u'main_categorysample')

        # Deleting model 'SiteConfiguration'
        db.delete_table(u'main_siteconfiguration')

        # Deleting field 'Product.photo'
        db.delete_column(u'main_product', 'photo')
    ...
    models = {
        ...
        u'main.siteconfiguration': {
            ...
            'active_background': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
