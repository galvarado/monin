...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'ProductSample.photo'
        db.alter_column(u'main_productsample', 'photo', self.gf('django.db.models.fields.files.FileField')(max_length=100, null=True))

        # Changing field 'Product.photo'
        db.alter_column(u'main_product', 'photo', self.gf('django.db.models.fields.files.FileField')(max_length=100, null=True))

    def backwards(self, orm):

        # Changing field 'ProductSample.photo'
        db.alter_column(u'main_productsample', 'photo', self.gf('django.db.models.fields.files.FileField')(default=None, max_length=100))

        # Changing field 'Product.photo'
        db.alter_column(u'main_product', 'photo', self.gf('django.db.models.fields.files.FileField')(default=None, max_length=100))
    ...
    models = {
        ...
        u'main.siteconfiguration': {
            ...
            'email_to_notifications': ('django.db.models.fields.EmailField', [], {'max_length': '75'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'})
        }
    }
