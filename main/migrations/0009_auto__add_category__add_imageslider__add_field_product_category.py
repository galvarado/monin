...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'main_imageslider', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=100)),
            ('active', self.gf('django.db.models.fields.BooleanField')(default=True)),
            ('photo', self.gf('django.db.models.fields.files.FileField')(max_length=100)),
        ))
        db.send_create_signal(u'main', ['ImageSlider'])

        # Adding field 'Product.category'
        db.add_column(u'main_product', 'category',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=None, related_name='products', to=orm['main.Category']),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        db.delete_table(u'main_imageslider')

        # Deleting field 'Product.category'
        db.delete_column(u'main_product', 'category_id')
