...
urlpatterns = patterns('main.views',
    ...
    url(r'^orders/delete/?$', 'orders_delete', name='orders_delete'),
    ...
    url(r'^checkorder/?$', 'checkorder', name='checkorder'),
    url(r'^order/?$', 'order', name='order'),
    url(r'^order/category/(?P<pk>\d+)?$', 'order_category', name='order_category'),
